// Test libertarian position matching
const userPosition = {EKO: 0.9, SOC: -0.5, SUV: -0.7};
...
console.log("Libertarian position (EKO: 0.9, SOC: -0.5, SUV: -0.7)");
...
console.log("For libertarian position EKO: 0.9 (right), SOC: -0.5 (liberal), SUV: -0.7 (euroskeptic):");
console.log("Should be: Svobodní, VOLUNTIA, Trikolóra");